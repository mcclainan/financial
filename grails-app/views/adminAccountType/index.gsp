...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa fa-accountType"></i><g:message code="adminAccountType.index.heading" default="Bank List"/> </h3>
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-cog"></i><g:message code="adminAccountType.index.heading" default="Bank"/></li>
                                ...
                                <section class="panel">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th>id</th>
                                                <th><g:message code="accountType.name.label"/></th>
                                            ...
                                            <g:each in="${accountTypeList}" var="accountType">
                                                <tr>
                                                    ...
                                                    <td><g:link action="show" id="${accountType.id}">${accountType.name}</g:link></td>
                                    ...
                                    <div class="panel-body">
                                        <g:form action="save">
                                            ...
                                            <div class="form-group">
                                                <label for="type"><g:message code="accountType.type.label"/> </label>
                                                <g:textField name="type" class="form-control" placeholder="Enter Name" value="${command?.type}"/>
                                            </div>
                                            <div class="form-group">
