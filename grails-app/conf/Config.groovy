...
grails.databinding.dateFormats = [
        'MMddyyyy', 'yyyy-MM-dd HH:mm:ss.S', "yyyy-MM-dd'T'hh:mm:ss'Z'", "yyyy/MM/dd"
]
...
twilio {
    ...
    apiID = 'AC9e1009f5d1cd82e6f70c37b42b5003ba'
    apiPass = '0443de7aada83aa9a5160d66ba02bcb6'
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	'/buttons':                       ['permitAll'],
	'/chart':                         ['permitAll'],
	'/form_component':                ['permitAll'],
	'/form_validation':               ['permitAll'],
	'/general':                       ['permitAll'],
	'/grids':                         ['permitAll'],
	'/login':                         ['permitAll'],
	'/profile':                       ['permitAll'],
